...
class m150121_103923_user_tables extends Migration
{
    public function up()
    {
        $this->execute("-- Create syntax for TABLE 'tbl_user_usercookies'
    ...
    {
        echo "m150121_103923_user_tables cannot be reverted.\n";
