<?php
    ...
    class Users extends ActiveRecord implements IdentityInterface {
        ...
        public function changePassword($email){
            if ($this->email === $email){
                ...
                if ($form->load(Yii::$app->request->post()) && $form->validate()){
                    ...
                    Yii::$app->session->setFlash('error', Yii::t('cms', 'new_password_error_valid'));
                }
            }else{
                Yii::$app->session->setFlash('error', Yii::t('cms', 'new_password_error_email'));
            }
        }
        ...
        public function sendInfoMail(){
            ...
            $template = '@vendor/albertborsos/yii2-cms/views/mail/info.php';
            $params = [
                'user' => $this,
            ];
